...
/**
 * Lucide-react removed brand/logo icons (Facebook, Twitter, etc.) in recent
 * versions since they're trademarked shapes, not generic icons. Keep these
 * as plain inline SVGs instead of pulling in a whole extra icon package.
 */
